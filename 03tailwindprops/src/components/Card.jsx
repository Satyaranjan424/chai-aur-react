...
function Card({username, userdescription}) {
  ...
  return (
    ...
    <h3 class="z-10 mt-3 text-3xl font-bold text-white">{username}</h3>
    <div class="z-10 gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">{userdescription}</div>
</article>
  )
}
